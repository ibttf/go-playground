    ...
    <div className="flex flex-col min-h-screen overflow-hidden">
      ...
      <main className="grow">
        <section className="relative">
          <div
            className={`${nycd.variable} ${aspekta.variable} scroll-smooth font-aspekta antialiased text-slate-800 font-[350] bg-white dark:bg-slate-900 dark:text-slate-200 absolute top-0 left-1/2 -translate-x-1/2 pointer-events-none -z-10`}
          >
            <Image
